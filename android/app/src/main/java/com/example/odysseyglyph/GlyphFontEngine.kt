...
object GlyphFontEngine {
    ...
    /**
     * Adapts a single word into 1, 2, or multiple chunks based on pixel width rather than raw character counts.
     */
    fun formatWordForDisplay(word: String, style: FontStyle, progress: Float = 0f): String {
        // Measure the unscaled text width. 24f gives some breathing room for autoScale down to 7.5f.
